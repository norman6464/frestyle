...
/** 左の列と画面のあいだに立つ。AppShell が画面ぜんぶを包む。 */
...
/**
 * 画面側が使う入口。この中に書いたものが左の列の差し込み口へ出る。
 *
 * 殻が無い場所（単体テストや story で画面だけを描くとき）では何も出さない
 * —— 殻が無いだけで画面が壊れるのは筋が通らないため。
 */
