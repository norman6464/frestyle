...
export interface KbTicketSavedFiltersProps {
  spaceId: string;
...
/**
 * KbTicketSavedFilters はサイドバーの「保存した絞り込み」（自分の担当・期限切れ・
 ...
 */
export default function KbTicketSavedFilters({ spaceId, counts }: KbTicketSavedFiltersProps) {
  return (
