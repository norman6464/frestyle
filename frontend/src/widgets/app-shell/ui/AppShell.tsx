...
export default function AppShell() {
  ...
  return (
    // 画面ごとの区画（ナレッジのスペースと木など）は、この差し込み口を通して本文の左の列へ入る。
    // 口を用意するのは殻、中身を入れるのは画面。
    <SidebarSlotProvider>
      <div className="h-dvh flex flex-col bg-surface overflow-hidden">
        ...
        {/* ヘッダーの下は横並び。画面が区画を差し込んだときだけ左に列、その右が本文。 */}
        <div className="flex min-h-0 flex-1">
          <ScreenSidebar mobileOpen={sidebarMobileOpen} onMobileClose={() => setSidebarMobileOpen(false)} />
